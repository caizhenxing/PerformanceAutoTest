...
<body>
	<div id=menu>
		...
		<form style="text-align: center" action="perfermanceTestServlet"
			method="post">
			<br> <br> IP:<input type="text" name="ip"><br>
			<br> port:<input type="text" name="port"><br> <br>
			path:<input type="text" name="path"><br> <br>
			param:<br> <br>
			<textarea rows="10" cols="30" name="param"></textarea>
			<br> <br> Concurrent users: <br>
			<input type="radio" name="vuser" value="50">50 <input
